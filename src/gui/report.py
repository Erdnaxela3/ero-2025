...
class DroneReport(Report):
    ...
    def create_report(self, G, node_path):
        ...
        self.report['total_cost'] = self.report['cumul_fix_cost'] + self.report['cumul_flight_cost']
...
class PlowReport(Report):
    ...
    def create_report(self, G, node_path, n=1):
        ...
        for i in range(n):
            ...
            h_cost = min(ot_lim, hour) * self.costs['h_cost'] + max(0, hour - ot_lim) * self.costs['overtime_h_cost']
        ...
        self.report['total_cost'] = self.report['cumul_fixed_cost'] + self.report['cumul_hour_cost'] + self.report['cumul_km_cost']
        self.report['total_distance'] = total_dist
        self.report['n_visited_street'] = n_edges_visited
        self.report['avg_edge_length'] = total_dist / n_edges_visited
